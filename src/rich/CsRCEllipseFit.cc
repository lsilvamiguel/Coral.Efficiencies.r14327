/*!
   \file    CsRCEllipseFit.cc
   \-----------------------
   \brief   CsRCEllipseFit class implementation.
...
//===========================================================================
  CsRCEllipseFit::CsRCEllipseFit(): CsRCChiSqFit() {}
//---------------------------------------------------


//===========================================================================
  CsRCEllipseFit::CsRCEllipseFit( const int nPoint,
//-------------------------------------------------------------------------
...
//===========================================================================
  void CsRCEllipseFit::print() const { CsRCChiSqFit::print(); }
//-------------------------------------------------------------

  CsRCEllipseFit::~CsRCEllipseFit() {}



//===========================================================================
  bool CsRCEllipseFit::doChiFit() {
//---------------------------------
...
//===========================================================================
  bool CsRCEllipseFit::fitIteration() {
//-------------------------------------
...
//===========================================================================
  bool CsRCEllipseFit::fitCheckConv() {
//-------------------------------------
...
//===========================================================================
  bool CsRCEllipseFit::doHist( const vector<CsHist2D*> vHisto ) {
//---------------------------------------------------------------

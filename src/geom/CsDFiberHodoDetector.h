...
/*!
   \file    CsDFiberHodoDetector.h
   \brief   Compass German Fiber Hodoscope like detector Class.
   \author  Benigno Gobbo
   \version $Revision: 1.11 $
   \date    $Date: 2011/02/03 14:48:10 $
*/

#ifndef CsDFiberHodoDetector_h
#define CsDFiberHodoDetector_h
...
/*! \class CsDFiberHodoDetector 
    \brief Compass Fiber Hodoscope like detector Class.
*/

class CsDFiberHodoDetector : public CsDetector {

 public:


  /*! \fn CsDFiberHodoDetector( const int row, 
  ...
  */
  CsDFiberHodoDetector( const int    row,
  ...
  private:
  //CsDFiberHodoDetector( const CsDFiberHodoDetector& ); //!< Copy constructor

  //CsDFiberHodoDetector& operator=( const CsDFiberHodoDetector& ); //!< Assign operator

  public:

  bool operator==( const CsDFiberHodoDetector& ) const; //!< "equal to" operator

  bool operator<( const CsDFiberHodoDetector& ) const; //!< "less than" operator
 ...
 public:
  ...
  public:
    ...
    friend std::istream& operator>>(std::istream& in,CsDFiberHodoDetector::Calib &c);
    friend std::istream& operator>>(std::istream& in,std::vector<CsDFiberHodoDetector::Calib> &vc);
  };

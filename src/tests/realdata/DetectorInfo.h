// $Id: DetectorInfo.h,v 1.2 2007/06/01 09:13:51 conrad Exp $
...
class DetectorInfo: public TObject {
  ...
  */
  ...
  /*! \fn  void DUtoCenter( double du )
     \brief update detector center position from an offset perp to the wire
  ...
  */
  ...
  RTInfo* rtInfo_;     //!< associated RT relation Object (created empty at constructor)
  ...
  double resid_;  //!< detector residual RMS taken from fit

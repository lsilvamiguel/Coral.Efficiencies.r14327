// $Id: RTInfo.cc,v 1.10 2002/08/17 20:54:26 hpereira Exp $
#include "RTInfo.h"
#include "Fit.h"
...
//_________________________________________________________________________________________
bool RTInfo::SetValidity( const char* start = "YYYY-MM-DD-hh:mm:ss", const char* stop = "YYYY-MM-DD-hh:mm:ss" )
{
...
//_________________________________________________________________________________________
bool RTInfo::WriteRTParToDB( const bool useMyT0 = false, const double myT0 = 0 )
{
  ...
  if( useMyT0 ) { 
    ...
    out.form( "%9.1f\n", myT0 );
    out << rtType << " ";
    for( unsigned int iP=0; iP < rtPar.size(); iP++ ) out.form( "%12.4e", (iP==0) ? (rtPar[iP]-myT0) : rtPar[iP] );
  } else {
    ...
    out.form( "%9.1f\n", rtPar[0] );
    out << rtType << "  ";
    for( unsigned int iP=0; iP < rtPar.size(); iP++ ) out.form( "%12.4e", (iP==0) ? 0.0:rtPar[iP] );
  }
...
//_________________________________________________________________________________________
bool RTInfo::WriteRTGridToDB( const bool useMyT0 = false, const double myT0 = 0 )
{

// $Id: Utils.h,v 1.4 2010/08/27 08:46:14 tnagel Exp $
...
public:
  ...
  /*! \fn static void  DumpMatrix( TMatrix m, std::ostream &out = std::cout )
    \brief dump root matrix to ostream in way I prefer to root way
    \param m   the matrix to be dumped
    \param out the output stream 
  */
  static void  DumpMatrix( TMatrix m, std::ostream &out = std::cout );
  ...
  */   
  ...
  //! Same as previous function, with 2D histograms
  static double HDiv(TH2* h1, TH2* h2, TH2* h3);
  ...
  */   
  ...
  /*! \fn static std::string GetTimeStamp( std::string format="%d_%m_%y.%H_%M_%S" )
  ...
  */
  ...
  /*! \fn static std::string CopyToLocal( std::string filename )
    \brief copy filename to local directory
    \param return local filename
  */
  static std::string CopyToLocal( std::string filename );

  /*! \fn static std::vector<std::string> GetFiles( std::string fileSelection )
  ...
  */  
  ...
  /*! \fn static void  MakeBackup( std::string filename )
  ...
  */
  ...
  /*! \fn static bool  Match( std::string s1, std::string s2 );
  ...
  */
  ...
  /*! \fn static std::string RemovePath( std::string filename )

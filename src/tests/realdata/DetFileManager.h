// $Id: DetFileManager.h,v 1.4 2010/03/16 08:33:04 suhl Exp $
...
class DetFileManager: public TObject {
  ...
  */
  DetFileManager( const char* detFileName );
  DetFileManager( void );  //!< useless constructor needed by root

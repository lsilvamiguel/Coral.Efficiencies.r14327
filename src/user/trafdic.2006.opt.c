...
// $Id: trafdic.2006.opt.c 13238 2012-02-02 17:34:58Z ybedfer $

// coral options c file for TraFDic on 2006 data
//
...
// Originally copied from "./trafdic.2004.opt.c,v1.12"
...
// TraFDic on 2006 data @ CERN.
#elif C2OPT_COMPUTERFARM == 2
// TraFDic on 2006 data @ gridKa.
#elif C2OPT_COMPUTERFARM == 3
// TraFDic on 2006 data @ Lyon.
#elif C2OPT_COMPUTERFARM == 4
// TraFDic on 2006 data @ Compass ONLINE.
#else
// TraFDic on 2006 data.
#endif

#ifdef C2OPT_BARE_FILE
//  ``Bare'' options file to be included in "$CORAL/src/alignment/traf.*.opt"
// files for processing 2006 FIELD ON data for alignment purposes:
...
//  And longitudinal setup ...since there is no transverse data in 2006.
...
//Data year   2006
//Data run select 52613
//Data container cdr22001-51392
#  elif C2OPT_COMPUTERFARM == 2
Data file 	/grid/fzk.de/compass/compass2/data/raw/2006/cdr22001-52613.raw
#  elif C2OPT_COMPUTERFARM == 3
Data file 	cchpsscompass:/hpss/in2p3.fr/group/compass/data/2006/W40/raw/cdr22001-52613.raw
#  elif C2OPT_COMPUTERFARM >= 4
Data file 	/castor/cern.ch/compass/data/2006/raw/W40/cdr22001-52613.raw
#  endif
#endif
...
detector table   	$COMPASS_FILES/geometry/2006/
//detector table   	$COMPASS_FILES/geometry/2006/detectors.52565.1T.minus.Z.dat
...
CsMaterialMap Zone_4		$COMPASS_FILES/maps/material/2006.03/material.rich.m2006.03.map
CsMaterialMap Zone_5		$COMPASS_FILES/maps/material/2006.03/material.hcal1.m2006.03.map
CsMaterialMap Zone_6		$COMPASS_FILES/maps/material/2006.03/material.muf1.m2006.03.map
CsMaterialMap Zone_7		$COMPASS_FILES/maps/material/2006.03/material.muf2.m2006.03.map
CsMaterialMap Zone_8		$COMPASS_FILES/maps/material/2006.03/material.muf3.m2006.03.map
...
use calibration
CDB use  	FileDB
CDB location  	$COMPASS_FILES/calibrations/2006
#else
use calibration
CDB use 	MySQLDB
#  if   C2OPT_COMPUTERFARM == 1
...
//CDB	entrytime 	2007-1-26-00:00:00 
...
//events BOS_skip 1.22			// skip first ~400(? cf. Jürgen) ms in spill (disabled in 2006)
...
BeamRecons BackTrack ResBMS  5.16   4.27   2.63   2.39	// Tuned on 06W45#54150
BeamRecons BackTrack Corr    8.22   4.54  -2.14  -6.90	// Tuned on 06W45#54150
...
CsMagInfo	MySQLDB
#else
CsMagInfo	File	~ybedfer/public/magInfo.2006.txt	// ...if MySQL not avail
#endif
...
//		***** OVERWRITE WHAT'S SET IN "../pkopt/trafdic.2006.opt" *****

//  Specify full path to some alternative dico file.
//TraF	Dicofit		$COMPASS_FILES/geometry/2006/dico.52565.1T.minus.Z

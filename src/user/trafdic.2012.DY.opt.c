...
// $Id: trafdic.2012.DY.opt.c 14070 2015-09-20 01:36:58Z lsilva $

// coral options c file for TraFDic on DY 2012 data
//
...
// Derived from "./trafdic.m2012.opt.c,v13720"
// Modified
// I) Following "~catarina/w0/phast.7.134/coral/test/temp/dy.2012.opt":
// - Special mDST options.
// - Updated ROOTGeometry file (and options).
// - Special "detectors.dat" and dico file (target, SM2, ECals commented out).
// - Special zone definitions and vertex options (including "RefBeam" @ -8m!).
// - Reference to dedicated "../pkopt/trigger.2012.DY.opt".
// II) But..
// - RICH and calo kept enabled (why not?).
// - Mapping, MM options kept as in original file.
// III) Dedicated block of options "SPECIAL SETTINGS FOR DY".
...
// TraFDic on 2012 DY data @ CERN.
#elif C2OPT_COMPUTERFARM == 2
// TraFDic on 2012 DY data @ gridKa.
#elif C2OPT_COMPUTERFARM == 3
// TraFDic on 2012 DY data @ Lyon.
#elif C2OPT_COMPUTERFARM == 4
// TraFDic on 2012 DY data @ Compass ONLINE.
#else
// TraFDic on 2012 DY data.
#endif
...
mDST select		1	// At least one vertex or particle
// - One may want to output more info, as exemplified infra:
mDST hits		HG MA	// MegaDST...
...
//					   ***** INPUT DATA...
#  if   C2OPT_COMPUTERFARM == 1
Data file	/castor/cern.ch/compass/data/2012/raw/W47/cdr02004-108876.raw
//Data file 	/afs/cern.ch/user/y/ybedfer/w0/evtDump/2012/evtDump.DY.MWAmuID-108876.raw
#  elif C2OPT_COMPUTERFARM == 2
Data file 	/grid/fzk.de/compass/compass2/data/raw/2012/cdr02004-108876.raw
#  elif C2OPT_COMPUTERFARM == 3
Data file	/hpss/in2p3.fr/group/compass/data/2012/raw/DY/evtDump.DY.MWAmuID-108876.raw
#  elif C2OPT_COMPUTERFARM >= 4
Data file	/castor/cern.ch/compass/data/2012/raw/W47/cdr02004-108876.raw
#  endif
#endif
...
// 					   ***** ROOTGeometry
CsROOTGeometry file	$COMPASS_FILES/geometry/DVCS.2012/ROOTGeometry/detectors.dvcs.r446.C
CsROOTGeometry  massDefault     .1057
...
//					   ***** MU' PID +  FLUX SCALERS
include ${CORAL}/src/pkopt/trigger.2012.DY.opt
#else
...
//  	 	 	 	 	   ***** GEOMETRICAL ZONES
define	 zone	-3500	  3500	 before M1
...
// - Special dico matching detectors.dat, cf. the "detector table" entry supra.
...
//TraF	ReMode	[49]	1
//   - Looser reco criteria and enlarged road widths.
//TraF	ReMode	[49]	2
// - Special set of "SmoothPos"
//TraF	SmoothPos [0]	1540.0  // Smooth track at MA02Y1 
//TraF  SmoothPos [1]	0	// Termination entry

#ifndef __PlaneFEMPanel__
#define __PlaneFEMPanel__
...
/// PlaneFEM control panel

class PlaneFEMPanel : public PlanePanel {
 ...
 public:
  PlaneFEMPanel(const TGWindow *p,const TGWindow *main,
		 UInt_t w, UInt_t h, PlaneFEM *plane);
  virtual ~PlaneFEMPanel();
  ...
  RQ_OBJECT("PlaneFEMPanel")
#else
  RQ_OBJECT()
#endif
  ClassDef(PlaneFEMPanel,1)
};
